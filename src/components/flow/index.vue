...
<div :class="b()" :style="styleName">
  <div :id="id" :style="styleName">
    ...
    <flow-node v-for="(node,index) in option.nodeList" :node="node" :id="node.id" @click.native="handleClick(node)" @changeNodeSite="changeNodeSite" :index="index" :active="active" :key="index">
